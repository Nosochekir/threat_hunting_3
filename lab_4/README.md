...
Подключение осуществляется через ssh-туннель (local port forwarding) к
сереверу на интефейс 127.0.0.1:8787.

`ssh user29@62.84.123.211 -i "<путь к ключу>" -L 8787:127.0.0.1:8787`
